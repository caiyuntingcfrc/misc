##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 1996 #####
...
# data source
path_code <- "AA170021/code85.docx"
path_dat <- "AA170021/inc85.dat"
year <- 85

# spss file for ref
# d.spss <- read_sav("AA170021/inc85.sav")
...
# .RData
# save df.inc (RData)
save(df.inc85, file = "AA170021/df_inc85.RData")
save(df.inc85, file = "R data files/df_inc85.RData")
# save df.inc (rds)
saveRDS(df.inc85, file = "AA170021/df_inc85.rds")
saveRDS(df.inc85, file = "R data files/df_inc85.rds")
# save code_tbl
save(code_tbl_85, file = "AA170021/code_tbl_85.RData")
save(code_tbl_85, file = "R data files/code_tbl_85.RData")
# save code_tbl (rds)
saveRDS(code_tbl_85, file = "AA170021/code_tbl_85.rds")
saveRDS(code_tbl_85, file = "R data files/code_tbl_85.rds")
