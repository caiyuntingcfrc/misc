##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 2006  #####
...
# data source
path_code <- "AA170031/code95.docx"
path_dat <- "AA170031/inc95.dat"
year <- 95
...
# .RData
# save df.inc
save(df.inc95, file = "AA170031/df_inc95.RData")
save(df.inc95, file = "R data files/df_inc95.RData")
# save code_tbl
save(code_tbl_95, file = "AA170031/code_tbl_95.RData")
save(code_tbl_95, file = "R data files/code_tbl_95.RData")
# .csv format
