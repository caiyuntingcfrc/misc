...
# prop.f
ll <- parLapply(cl, l, prop.f, weight = "a20", age = 18)
...
ll <- parLapply(cl, l, prop.f, weight = "a20", age = 12)
...
ll <- parLapply(cl, l, prop.f, weight = "a20", age = 6)
...
d.core <- parLapply(cl, l, filter_at, "a18", all_vars(. %in% c(421, 422, 431, 432)))
# d89
d89 <- df.inc89 %>% 
        filter_at("a18", all_vars(. %in% c(421, 422, 431, 432)))
prop.core18 <- parLapply(cl, d.core, prop.f, weight = "a20", age = 18)
...
prop.core12 <- parLapply(cl, d.core, prop.f, weight = "a20", age = 12)
...
prop.core6 <- parLapply(cl, d.core, prop.f, weight = "a20", age = 6)
...
d.stem <- parLapply(cl, l, filter_at, "a18", all_vars(. %in% c(611, 612, 
                                                        621, 622, 
                                                        631, 632)))
# d89
d89 <- df.inc89 %>% 
        filter_at("a18", all_vars(. %in% c(611, 612, 
                                           621, 622, 
                                           631, 632)))
prop.stem18 <- parLapply(cl, d.stem, prop.f, weight = "a20", age = 18)
...
prop.stem12 <- parLapply(cl, d.stem, prop.f, weight = "a20", age = 12)
...
prop.stem6 <- parLapply(cl, d.stem, prop.f, weight = "a20", age = 6)
...
rm(list = grep("^df.inc[1][0][0-9]|^df.inc[9][0-9]", ls(), value = TRUE))
# prop.e
ll <- parLapply(cl, l, prop.e, weight = "a20", age = 65)
...
ll <- parLapply(cl, l, prop.e, weight = "a20", age = 75)
...
ll <- parLapply(cl, l, prop.e, weight = "a20", age = 85)
...
d89 <- df.inc89 %>% 
        filter_at("a18", all_vars(. %in% c(421, 422, 431, 432)))
prop.core65 <- parLapply(cl, d.core, prop.e, weight = "a20", age = 65)
...
prop.core75 <- parLapply(cl, d.core, prop.e, weight = "a20", age = 75)
...
prop.core85 <- parLapply(cl, d.core, prop.e, weight = "a20", age = 85)
...
d89 <- df.inc89 %>% 
        filter_at("a18", all_vars(. %in% c(611, 612, 
                                           621, 622, 
                                           631, 632)))
prop.stem65 <- parLapply(cl, d.stem, prop.e, weight = "a20", age = 65)
...
prop.stem75 <- parLapply(cl, d.stem, prop.e, weight = "a20", age = 75)
...
prop.stem85 <- parLapply(cl, d.stem, prop.e, weight = "a20", age = 85)
