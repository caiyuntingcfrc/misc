##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 1999 #####
...
# data source
path_code <- "AA170024/code88.docx"
path_dat <- "AA170024/inc88.dat"
year <- 88
...
# .RData
# save df.inc (RData)
save(df.inc88, file = "AA170024/df_inc88.RData")
save(df.inc88, file = "R data files/df_inc88.RData")
# save df.inc (rds)
saveRDS(df.inc88, file = "AA170024/df_inc88.rds")
saveRDS(df.inc88, file = "R data files/df_inc88.rds")
# save code_tbl
save(code_tbl_88, file = "AA170024/code_tbl_88.RData")
save(code_tbl_88, file = "R data files/code_tbl_88.RData")
# save code_tbl (rds)
saveRDS(code_tbl_88, file = "AA170024/code_tbl_88.rds")
saveRDS(code_tbl_88, file = "R data files/code_tbl_88.rds")
