##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 1990 #####
...
# data source
path_code <- "AA170015/code79.docx"
path_dat <- "AA170015/inc79.dat"
year <- 79

# spss file for ref
d.spss <- read_sav("AA170015/inc79.sav")
...
# .RData
# save df.inc (RData)
save(df.inc79, file = "AA170015/df_inc79.RData")
save(df.inc79, file = "R data files/df_inc79.RData")
# save df.inc (rds)
saveRDS(df.inc79, file = "AA170015/df_inc79.rds")
saveRDS(df.inc79, file = "R data files/df_inc79.rds")
# save code_tbl
save(code_tbl_79, file = "AA170015/code_tbl_79.RData")
save(code_tbl_79, file = "R data files/code_tbl_79.RData")
# save code_tbl (rds)
saveRDS(code_tbl_79, file = "AA170015/code_tbl_79.rds")
saveRDS(code_tbl_79, file = "R data files/code_tbl_79.rds")
