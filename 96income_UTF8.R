##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 2007  #####
...
# data source
path_code <- "AA170032/code96.docx"
path_dat <- "AA170032/inc96.dat"
year <- 96
...
# .RData
# save df.inc
save(df.inc96, file = "AA170032/df_inc96.RData")
save(df.inc96, file = "R data files/df_inc96.RData")
# save code_tbl
save(code_tbl_96, file = "AA170032/code_tbl_96.RData")
save(code_tbl_96, file = "R data files/code_tbl_96.RData")
# .csv format
