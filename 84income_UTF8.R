##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 1995 #####
...
# data source
path_code <- "AA170020/code84.docx"
path_dat <- "AA170020/inc84.dat"
year <- 84

# spss file for ref
# d.spss <- read_sav("AA170020/inc84.sav")
...
# .RData
# save df.inc (RData)
save(df.inc84, file = "AA170020/df_inc84.RData")
save(df.inc84, file = "R data files/df_inc84.RData")
# save df.inc (rds)
saveRDS(df.inc84, file = "AA170020/df_inc84.rds")
saveRDS(df.inc84, file = "R data files/df_inc84.rds")
# save code_tbl
save(code_tbl_84, file = "AA170020/code_tbl_84.RData")
save(code_tbl_84, file = "R data files/code_tbl_84.RData")
# save code_tbl (rds)
saveRDS(code_tbl_84, file = "AA170020/code_tbl_84.rds")
saveRDS(code_tbl_84, file = "R data files/code_tbl_84.rds")
