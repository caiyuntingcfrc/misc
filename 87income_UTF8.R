##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 1998 #####
...
# data source
path_code <- "AA170023/code87.docx"
path_dat <- "AA170023/inc87.dat"
year <- 87

# spss file for ref
# d.spss <- read_sav("AA170023/inc87.sav")
...
# .RData
# save df.inc (RData)
save(df.inc87, file = "AA170023/df_inc87.RData")
save(df.inc87, file = "R data files/df_inc87.RData")
# save df.inc (rds)
saveRDS(df.inc87, file = "AA170023/df_inc87.rds")
saveRDS(df.inc87, file = "R data files/df_inc87.rds")
# save code_tbl
save(code_tbl_87, file = "AA170023/code_tbl_87.RData")
save(code_tbl_87, file = "R data files/code_tbl_87.RData")
# save code_tbl (rds)
saveRDS(code_tbl_87, file = "AA170023/code_tbl_87.rds")
saveRDS(code_tbl_87, file = "R data files/code_tbl_87.rds")
