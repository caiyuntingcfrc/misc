##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 2008  #####
...
# data source
path_code <- "AA170033/code97.docx"
path_dat <- "AA170033/inc97.dat"
year <- 97
...
l <- grep("x1|b4|b21|b23|b25", variables)
# mutate_if
...
# .RData
# save df.inc
save(df.inc97, file = "AA170033/df_inc97.RData")
save(df.inc97, file = "R data files/df_inc97.RData")
# save code_tbl
save(code_tbl_97, file = "AA170033/code_tbl_97.RData")
save(code_tbl_97, file = "R data files/code_tbl_97.RData")
# .csv format
