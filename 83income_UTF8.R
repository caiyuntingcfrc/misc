##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 1994 #####
...
# data source
path_code <- "AA170019/code83.docx"
path_dat <- "AA170019/inc83.dat"
year <- 83

# spss file for ref
# d.spss <- read_sav("AA170019/inc83.sav")
...
l <- grep("x1|b4|b17|b18", variables)
# mutate_if
...
# .RData
# save df.inc (RData)
save(df.inc83, file = "AA170019/df_inc83.RData")
save(df.inc83, file = "R data files/df_inc83.RData")
# save df.inc (rds)
saveRDS(df.inc83, file = "AA170019/df_inc83.rds")
saveRDS(df.inc83, file = "R data files/df_inc83.rds")
# save code_tbl
save(code_tbl_83, file = "AA170019/code_tbl_83.RData")
save(code_tbl_83, file = "R data files/code_tbl_83.RData")
# save code_tbl (rds)
saveRDS(code_tbl_83, file = "AA170019/code_tbl_83.rds")
saveRDS(code_tbl_83, file = "R data files/code_tbl_83.rds")
