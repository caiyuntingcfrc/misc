##### author: CAI YUN-TING ######
##### The Survey of Family Income and Expenditure, 2004 #####
...
# data source
path_code <- "AA170029/code93.docx"
path_dat <- "AA170029/inc93.dat"
year <- 93
...
# .RData
# save df.inc
save(df.inc93, file = "AA170029/df_inc93.RData")
save(df.inc93, file = "R data files/df_inc93.RData")
# save code_tbl
save(code_tbl_93, file = "AA170029/code_tbl_93.RData")
save(code_tbl_93, file = "R data files/code_tbl_93.RData")
# .csv format
